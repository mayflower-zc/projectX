...
public class BaiduMusicService {
    public static Music searchMusic(String musicTitle, String musicAuthor) {
        ...
        //对音乐名称、作者进行URL编码
        requestUrl = requestUrl.replace("{TITLE}", HttpRequestUtil.urlEncodeUTF8(musicTitle));
        requestUrl = requestUrl.replace("{AUTHOR}", HttpRequestUtil.urlEncodeUTF8(musicAuthor));
        // 处理名称、作者中间的空格
    ...
    public static void main(String[] args) {
        Music music = searchMusic("洋葱", "杨宗纬");
